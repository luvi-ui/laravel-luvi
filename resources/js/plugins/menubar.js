export default function (Alpine) {
    // prettier-ignore
    Alpine.directive("menubar", (el, directive) => {
        if (!directive.value) handleRoot(el, Alpine);
        else if (directive.value === "menu") handleMenu(el, Alpine);
...
function handleMenu(el, Alpine) {
    Alpine.bind(el, {
        "x-id"() {
            return ["alpine-menu", "alpine-menu-button", "alpine-menu-items"];
        },
        ":id"() {
            return this.$id("alpine-menu");
        },
        ...
        return {
            "x-data"() {
                return {
                    ...
                    __defaultValue: "",
                    // FIX:
                    //__foo is a duplicate of __isChecked but
